...
var allfoodtypesRouter = require('./routes/allfoodtypes');
var allfooditemsRouter = require('./routes/allfooditems');
...
app.use('/allfoodtypes', allfoodtypesRouter);
app.use('/allfooditems', allfooditemsRouter);
