  ...
  const handleClose=()=>{
    ...
    return(
     <div className={classes.root}>
        ...
        <Grid item xs={12} sm={6}>
        <TextField  onChange={(event)=>setOwnerName(event.target.value)} label="Owner Name" fullWidth variant="outlined" />    
        </Grid>   
        ...
        <Grid item xs={12} sm={4}>
        <TextField label="Zip Code" onChange={(event)=>setZipcode(event.target.value)} fullWidth variant="outlined" />    
        </Grid>

        <Grid item xs={12} sm={6}>
        <TextField label="Email Id" onChange={(event)=>setEmailAddress(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  

        <Grid item xs={12} sm={6}>
        <TextField label="Mobile Number" onChange={(event)=>setMobileNumber(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  

        
        <Grid item xs={12} sm={6}>
        <TextField label="Location" onChange={(event)=>setLocation(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
        ...
        <Grid item xs={12} sm={6}>
        <TextField label="Shop Act/Company" onChange={(event)=>setShopAct(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={shopActImage.file} className={classes.large} /> 
        ...
        <Grid item xs={12} sm={6}>
        <TextField label="ID Proof" onChange={(event)=>setId(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={idProofImage.file} className={classes.large} /> 
        ...
        <Grid item xs={12} sm={6}>
        <TextField label="Fssai" onChange={(event)=>setFssai(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={logo.file} className={classes.large} /> 
        ...
        <Grid item xs={12}>
        <TextField label="GST" onChange={(event)=>setGst(event.target.value)} fullWidth variant="outlined" />    
