...
export default function AllRestaurant() {
    ...
    const [shopActImage,setShopActImage]=useState({bytes:'',file:'/noimage.jpg'})
    ...
    'shopact':shopAct,
     ...
     var res=await postData(
       "restaurant/editrestaurant",body);
  ...
  const handleSaveShopActImage=async()=>{
    ...
    if (res.result){
      swal({
        title: "Shop Act Image Update Successfully",
        icon: "success",
        dangerMode: true,
      });
    } 
  ...
  const handleShopAct=(event)=>{ setShopActImage({
  ...
  const handleDOpen=(data)=>{
    ...
    const showEditDialog=()=>{
      return (
        ...
        <Grid item xs={12} sm={6}>
        <TextField  onChange={(event)=>setOwnerName(event.target.value)} label="Owner Name"
         value={ownerName} 
        fullWidth
        ...
        value={zipcode}
        onChange={(event)=>setZipcode(event.target.value)} fullWidth
         variant="outlined" />    
        </Grid>
        ...
        value={emailAddress}
         onChange={(event)=>setEmailAddress(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  

        <Grid item xs={12} sm={6}>
        <TextField label="Mobile Number"
        value={mobileNumber}
         onChange={(event)=>setMobileNumber(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
        ...
        value={location}
        onChange={(event)=>setLocation(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  
        ...
        <Grid item xs={12} sm={6}>
        <TextField label="Shop Act/Company" onChange={(event)=>setShopAct(event.target.value)} fullWidth
        value={shopAct}
        variant="outlined" />    
        </Grid>  
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={shopActImage.file} className={classes.large} /> 
      {btnShopAct?<Button color="primary" style={{padding:5}} onClick={()=>handleSaveShopActImage()}>Save</Button>:<></> }
      </div>
        </Grid>  

        <Grid item xs={12} sm={6}>
        <TextField label="ID Proof" 
         value={id}
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={idProofImage.file} className={classes.large} /> 
      </div>
        </Grid>  

        <Grid item xs={12} sm={6}>
        <TextField label="Fssai"
         value={fssai}
         onChange={(event)=>setFssai(event.target.value)} fullWidth variant="outlined" />    
        </Grid>  

        <Grid item xs={12} sm={6}>
          <div style={{display:'flex' ,flexDirection:'row',justifyContent:'center',alignItems:'center'}} >
        <input accept="image/*" className={classes.input} id="icon-button-fssai" type="file" 
           multiple
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={fssaiImage.file} className={classes.large} /> 
      </div>
        </Grid>  
        ...
        <Grid item xs={12} sm={6}>
          <div style={{display:'flex' ,flexDirection:'row',justifyContent:'center',alignItems:'center'}} >
        <input accept="image/*" className={classes.input} id="icon-button-logo" type="file" 
        multiple
      ...
      <Avatar alt="Remy Sharp" variant='rounded' style={{marginLeft:20}} src={logo.file} className={classes.large} /> 
      </div>
        </Grid> 
        ...
        <TextField label="GST" 
         value={gst}
        onChange={(event)=>setGst(event.target.value)} fullWidth variant="outlined" />    
    ...
    return (
      ...
      <MaterialTable
        ...
        columns={[
          ...
          { title: 'Contact', field: 'Name',render:rowData=>
          <div style={{flexDirection:'column'}}>
        ...
        { title: 'GST/Fssai', field: 'Name',render:rowData=>
        <div style={{flexDirection:'column'}}>
          <div><b>{rowData.gst}</b></div>
          <div>{rowData.fssai},{rowData.status}</div>
          </div>
      },


      { title: 'Logo', field: 'Name',render:rowData=>
